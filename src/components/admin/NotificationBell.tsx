        ...
        {open && (
          <>
            ...
            <motion.div
              ...
              className="absolute right-0 top-full z-50 mt-2 w-80 max-w-[calc(100vw-1.5rem)] origin-top-right border border-border/60 bg-card/95 p-2 shadow-xl backdrop-blur-sm"
            >
