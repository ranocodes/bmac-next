...
export default function Contact() {
  ...
  return (
    <main suppressHydrationWarning className="bg-background">
      ...
      <section className="py-12 md:py-20 px-6">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12">
          ...
          <div className="lg:col-span-7">
             <div className="bg-card rounded-bento p-6 md:p-12 shadow-xl border border-border relative overflow-hidden">
                  ...
                  <form action={formAction} className="space-y-4 md:space-y-6">
                    <div className="grid md:grid-cols-2 gap-4 md:gap-6">
                       <div className="space-y-1.5">
                          ...
                          <input name="name" type="text" placeholder="Peace Jagaban" className="w-full px-5 md:px-6 py-3.5 md:py-4 bg-muted/50 border border-border rounded-xl md:rounded-2xl text-sm focus:outline-none focus:ring-2 focus:ring-primary/20" required />
                       </div>
                       <div className="space-y-1.5">
                          <label className="text-[9px] font-bold uppercase tracking-widest text-muted-foreground ml-2">Email Address</label>
                          <input name="email" type="email" placeholder="peace@bmacjos.org" className="w-full px-5 md:px-6 py-3.5 md:py-4 bg-muted/50 border border-border rounded-xl md:rounded-2xl text-sm focus:outline-none focus:ring-2 focus:ring-primary/20" required />
                       </div>
                    </div>
                    
                    <div className="space-y-1.5">
                       <label className="text-[9px] font-bold uppercase tracking-widest text-muted-foreground ml-2">Subject</label>
                       <select name="subject" className="w-full px-5 md:px-6 py-3.5 md:py-4 bg-muted/50 border border-border rounded-xl md:rounded-2xl text-sm focus:outline-none focus:ring-2 focus:ring-primary/20">
                    ...
                    <div className="space-y-1.5">
                       ...
                       <textarea name="message" rows={4} placeholder="How can we help?" className="w-full px-5 md:px-6 py-3.5 md:py-4 bg-muted/50 border border-border rounded-xl md:rounded-2xl text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 resize-none" required />
                    </div>
          ...
          <div className="lg:col-span-5 space-y-6 md:space-y-8">
             <div className="bg-secondary rounded-bento p-8 md:p-10 text-secondary-foreground relative overflow-hidden">
                ...
                <div className="space-y-6 md:space-y-8 relative z-10">
                   {[
                     ...
                     <div key={i} className="flex gap-4 md:gap-5 justify-center md:justify-start text-center md:text-left">
                        <div className="w-9 h-9 md:w-10 md:h-10 rounded-xl bg-card/5 border border-card/10 flex items-center justify-center text-accent flex-shrink-0">
                           {item.icon}
                        </div>
                        <div>
             ...
             <div className="relative h-[250px] md:h-[300px] rounded-bento overflow-hidden border border-border">
                <iframe
      ...
      <section className="py-20 md:py-24 px-6 bg-muted/50">
         <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-4">
               {faqs.map((faq, i) => (
                 <div key={i} className="bg-card rounded-2xl md:rounded-3xl border border-border overflow-hidden shadow-sm">
                    <button 
                    ...
                    <AnimatePresence>
                       {openFaq === i && (
                         <motion.div initial={{ height: 0 }} animate={{ height: 'auto' }} exit={{ height: 0 }} className="overflow-hidden">
                            <div className="px-6 md:px-8 pb-6 md:pb-8 text-muted-foreground text-xs md:text-sm leading-relaxed border-t border-border/50 pt-4">
                               {faq.a}
                            </div>
                         </motion.div>
                       )}
