...
export default function Home() {
  ...
  return (
    <main suppressHydrationWarning className="bg-[#fafbf9]">
      <section className="relative min-h-[90dvh] lg:min-h-[95dvh] flex items-center overflow-hidden pt-28 lg:pt-20 pb-12">
         ...
         <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center relative z-10">
            ...
            >
               ...
               <div className="absolute bottom-4 lg:bottom-10 left-4 lg:left-10 right-4 lg:right-10 bg-white/90 backdrop-blur-xl p-6 lg:p-8 rounded-[1.5rem] lg:rounded-[2.5rem] border border-white/20 flex justify-between items-center gap-2">
                  {stats.map((stat, i) => (
                 ...
                 >
                    <Link href={`/programs/${prog.id}`} className="flex flex-col h-full">
                      <div className="relative h-48 lg:h-56 w-full overflow-hidden shrink-0 border-b border-slate-50">
                         ...
                         <div className="absolute top-4 lg:top-6 left-4 lg:left-6 p-2.5 rounded-xl bg-white/90 backdrop-blur-md shadow-sm">
                            <div className={prog.color}>{prog.icon}</div>
                         </div>
                      </div>
                      
                      <div className="p-8 flex flex-col flex-grow bg-white">
                         <h3 className="font-display text-xl lg:text-2xl font-bold text-deep mb-3 tracking-tight">{prog.title}</h3>
                         ...
                         <div className="mt-auto pt-6 border-t border-slate-50 flex justify-between items-center">
                            ...
                            <div className="w-9 h-9 lg:w-10 lg:h-10 rounded-full bg-slate-50 flex items-center justify-center text-slate-400 group-hover:bg-green group-hover:text-white transition-colors">
                               <ArrowRight size={18} />
                            </div>
                         </div>
                      </div>
      ...
      <section className="py-24 lg:py-32 px-6 bg-deep overflow-hidden relative text-center md:text-left">
         ...
         <div className="max-w-5xl mx-auto w-full">
            <BentoCard className="bg-[#0f6b3e] p-10 md:p-16 lg:p-24 text-center relative overflow-hidden border-none shadow-2xl shadow-emerald-900/20">
               ...
               <div className="relative z-10">
                  <h2 className="font-display text-[clamp(1.75rem,6vw,4rem)] font-extrabold text-white tracking-tighter mb-6 lg:mb-8 leading-tight">
                  ...
                  <div className="flex flex-wrap justify-center gap-4">
                     <button onClick={() => setIsModalOpen(true)} className="bg-gold text-deep px-10 lg:px-14 py-4 lg:py-6 rounded-full font-bold hover:bg-white transition-all shadow-xl shadow-gold/10 text-sm lg:text-base">
                        Join the Movement
                     </button>
